...
def main():
    ...
    parser.add_argument('--train_path', type=str, default='/tmp/train/',
    ...
    parser.add_argument('--save_freq', type=int, default=100, help='The frequency of saving the trained model.')
